...
1. Download `dist/AtmosViz_v0.6.0_Windows_VST3.zip`.
...
5. Extract `dist/AtmosViz_v0.6.0_Windows_Standalone.zip` and run `AtmosViz.exe` for the standalone tool.

**macOS (AU / VST3 / Standalone / CLAP)**
1. Download the macOS release zips currently published (`dist/AtmosViz_v0.6.0_macOS_AU.zip`, `dist/AtmosViz_v0.6.0_macOS_VST3.zip`, `dist/AtmosViz_v0.6.0_macOS_Standalone.zip`) and/or the CLAP bundle (`dist/AtmosViz_v0.6.0_macOS_CLAP.clap`).
